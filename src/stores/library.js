...
export const useLibraryStore = defineStore('library', () => {
  ...
  function saveSettings(playerStore) {
    ...
    const settings = {
      ...
      convolutionFileName: playerStore ? playerStore.convolutionFileName : null,
      convolutionMainGain: playerStore ? playerStore.convolutionMainGain : 0,
      convolutionSendGain: playerStore ? playerStore.convolutionSendGain : 0,
      convolutionSelectionKey: playerStore ? playerStore.convolutionSelectionKey : 'builtin:default',
      convolutionPresets: playerStore && playerStore.convolutionPresets ? [...playerStore.convolutionPresets] : [],
